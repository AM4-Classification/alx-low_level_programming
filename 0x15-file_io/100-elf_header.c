 ...
 * @e_ident: Pointer to an array containing the ELF magic numbers
 *
 * Description: If file is not ELF file - exit code will be 98
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_class - will pints the class of an ELF header
 ...
 *
 * Description: If file cannot be closed - exit code will be 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
